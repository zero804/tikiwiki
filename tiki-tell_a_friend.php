...
if (isset($_POST['send'])) {
	...
	if (!empty($_POST['addresses'])) $smarty->assign('addresses', $_POST['addresses']);
	if (!empty($_POST['name'])) $smarty->assign('name', $_POST['name']);
	if (!empty($_POST['comment'])) $smarty->assign('comment', $_POST['comment']);
	if (empty($errors)) {

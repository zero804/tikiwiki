 ...
 * @param $installer
 */
function upgrade_20190217_sql_upgrade_fix_from_older_tiki($installer)
{
	$query = <<<SQL
...
ALTER TABLE `tiki_secdb` ADD PRIMARY KEY (`filename`,`tiki_version`);
...
ALTER TABLE `tiki_webmail_contacts_groups` ADD PRIMARY KEY (`contactId`,`groupName`(200));

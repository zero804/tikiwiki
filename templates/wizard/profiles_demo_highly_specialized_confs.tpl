...
<div class="media">
	...
	<div class="media-body">
		<h4 class="media-heading margin-bottom-md">{tr}Some profiles are highly customized for very specialized use cases, and they are listed in this special category.{/tr}</h4>

...
<div class="media">
	...
	<div class="media-body">
		<h4 class="media-heading margin-bottom-md">{tr}Check out this set of potentially useful profiles for your site which involve small amount of changes in your site configuration{/tr}.</h4>

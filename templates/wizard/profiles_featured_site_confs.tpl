...
<div class="media">
	<div class="media-left">
		<span class="fa-stack fa-lg" style="width: 100px" title="{tr}Configuration Profiles Wizard{/tr}" >
			...
			<i class="fa fa-rotate-270 fa-magic fa-stack-2x"></i>
		</span>
	</div>
	<div class="media-body">
		<h4 class="media-heading">{tr}Initialize Tiki as an application, e.g. a blog., by means of applying one of the 4 featured configuration profiles{/tr}.</h4>

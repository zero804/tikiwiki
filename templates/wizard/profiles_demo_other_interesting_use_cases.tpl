...
<div class="media">
	...
	<div class="media-body">
		<h4 class="media-heading margin-bottom-md">{tr}Each of these profiles create a working instance of some features, such as wiki structures, forums, trackers and wiki pages, customized for specific purposes{/tr}.</h4>

...
<div class="t_navbar mb-4">
	{button href="tiki-list_quizzes.php" _type="btn btn-info" _text="{tr}List Quizzes{/tr}"}
	{button href="tiki-quiz_stats.php" _type="btn btn-info" _text="{tr}Quiz Stats{/tr}"}
	{button href="tiki-quiz_stats_quiz.php?quizId=$quizId" _type="btn btn-info" _text="{tr}This Quiz Stats{/tr}"}

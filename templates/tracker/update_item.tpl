...
{block name="content"}
	...
	{else}
		<form method="post" class="" action="{service controller=tracker action=update_item format=$format editItemPretty=$editItemPretty}" id="updateItemForm{$trackerId|escape}">

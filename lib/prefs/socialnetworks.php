...
function prefs_socialnetworks_list()
{
	return [
		...
		'socialnetworks_twitter_site_name' => [
			...
			'description' => tra('The default website name that will be used by Twitter (twitter:site) for every webpage. This parameter will be used instead of the browser title.'),
			'keywords' => 'social networks',
			'type' => 'text',
			'size' => 60,
			'default' => '',
		...
		'socialnetworks_twitter_site_image' => [
			...
			'description' => tra('The default image (logo, picture, etc) that will be used by Twitter (twitter:image) for every webpage. The image must be specified as a URL.'),
			'keywords' => 'social networks',
			'type' => 'text',
			'size' => 60,
			'default' => '',
